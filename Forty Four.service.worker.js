...
/** @type {string} */
const CACHE_VERSION = '1758627863|726403582';
/** @type {string} */
const CACHE_PREFIX = 'Forty Four-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Forty Four.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Forty Four.html","Forty Four.js","Forty Four.offline.html","Forty Four.icon.png","Forty Four.apple-touch-icon.png","Forty Four.audio.worklet.js","Forty Four.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Forty Four.wasm","Forty Four.pck"];
